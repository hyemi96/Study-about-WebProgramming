...
public final class SMSFactory {
	...
	public SMSFactory(String tempKey, String phone) throws Exception {
		...
		user_id = base64Encode("remember1562");	//아이디
		...
		first_phone_number = base64Encode(nullcheck("02", ""));
		second_phone_number = base64Encode(nullcheck("6323", ""));
		third_phone_number = base64Encode(nullcheck("9764", ""));
